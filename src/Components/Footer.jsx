...
const Footer = () => {
  return (
    <div className=" flex gap-1 w-full h-screen bg=zinc-900 p-20 Font-['neue montreal']">
      <div className='w-1/2 h-full flex flex-col justify-between  '>
        <div className="heading">
          <h1 className="text-[8vw] font-semibold uppercase leading-none -mb-10">
            EYE-
          </h1>
          <h1 className=" mt-5 text-[8vw] font-semibold uppercase leading-none -mb-10">
            OPENING
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2">
        ...
        presentations
         ...
         <div className="dets font-['neue montreal'] mt-40 ">
      ...
      {/* for extra content and the extra links we can add some another div afterwards */}
    </div>
  )
};
